...
\begin{problem}
  ...
  \begin{image}
    \includegraphics[scale = 0.1]{Images/"Velocity large graph solution".png}
  \end{image}
\end{problem}
...
Solve the following word problems:
	...
	$v(t) = -t^2 + 4t - 3$ feet per minute.
		...
		\item  Find the total displacement the man traveled from $2$ minutes to $6$ minutes (assume east is positive).
			\begin{freeResponse}
		...
		\item  Find the total distance the man traveled from $2$ minutes to $6$ minutes.
			\begin{freeResponse}
