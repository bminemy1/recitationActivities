...
\title{Breakout Session 17 Solutions}
...
\begin{problem}
  ...
  \begin{freeResponse}
    \begin{image}
      \includegraphics[scale = 0.07]{Images/"Graph function 1".pdf}
    \end{image}
    \begin{image}
      \includegraphics[scale = 0.07]{Images/"Graph function 2".pdf}
    \end{image}

    \begin{image}
      \includegraphics[scale = 0.07]{Images/"Graph function 3".pdf}
    \end{image}

    \begin{image}
      \includegraphics[scale = 0.5]{Images/"Graph function 4".png}
    \end{image}

    \begin{image}
      \includegraphics[scale = 0.5]{Images/"Graph function 5".png}
    \end{image}

    \begin{image}
      \includegraphics[scale = 0.5]{Images/"Graph function 6".png}
    \end{image}

    \begin{image}
      \includegraphics[scale = 0.5]{Images/"Graph function 7".png}
    \end{image}
  \end{freeResponse}
\end{problem}
