...
\title{Breakout Session 22 Solutions}
...
\begin{problem}
  ...
  \outcome{Compute left, right, and midpoint Riemann Sums.}
  \outcome{Express sums using sigma notation.}
...
\begin{problem}
  \outcome{Express sums using sigma notation.} 
  \outcome{Associate the components of the sum formula with their geometric meaning.}
